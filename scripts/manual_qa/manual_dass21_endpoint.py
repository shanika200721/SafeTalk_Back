...
def main():
    ...
    if login_response.status_code != 200:
        print(f"âŒ Login failed: {login_response.status_code}")
    ...
    if response.status_code == 200:
        print("\nâœ… DASS21 Assessment submitted successfully!")
        data = response.json()
        ...
        print("\nâŒ Failed to submit DASS21 Assessment")

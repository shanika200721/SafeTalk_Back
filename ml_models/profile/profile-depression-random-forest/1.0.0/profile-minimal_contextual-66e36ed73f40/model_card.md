...
Model name: profile-depression-random-forest
...
Feature set: minimal_contextual

Selected candidate: random_forest_n=50_depth=4_leaf=1_class_weight=none_threshold=max_f1

Threshold policy: max_f1 at threshold 0.3350752136657455. Selected with validation data only and not clinically validated.
